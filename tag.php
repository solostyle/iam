...
if ( (isset($_SESSION['user_id']) &&
	...
	print list_months("start_month",$_SESSION['tag_start_month']);
	print '&nbsp;';
	print list_years("start_year",$_SESSION['tag_start_year']);
	print '</p>';
	print '<p>Ending date: ';
	print list_months("end_month",$_SESSION['tag_end_month']);
	print '&nbsp;';
	print list_years("end_year",$_SESSION['tag_end_year']);
	print '</p>';
	...
	if (isset($_POST['start_month'])) {
		...
		print '<div><form name="tag" method="post" action="tag-confirm.php">';
		print show_entries_by_time($start_f, $end_f, "tag");
		print '<input type="submit" name="submit_tag" value="tag" />
			</form></div>';

		// Save in SESSION: list_months and list_years use these 
		$_SESSION['tag_start_month'] = $_POST['start_month'];
		$_SESSION['tag_start_year'] = $_POST['start_year'];
		$_SESSION['tag_end_year'] = $_POST['end_year'];
		$_SESSION['tag_end_month'] = $_POST['end_month'];
	}
